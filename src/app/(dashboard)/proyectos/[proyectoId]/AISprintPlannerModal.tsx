...
export default function AISprintPlannerModal({
  ...
  const modalJSX = (
    ...
    >
      <div
        className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden border border-indigo-100 animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh] relative z-[10000]"
