  ...
  return (
    <>
      ...
      {isOpen && (
        ...
        >
          <div
            className="bg-white rounded-3xl shadow-2xl w-full max-w-3xl overflow-hidden border border-emerald-100 animate-in zoom-in-95 duration-200 flex flex-col max-h-[92vh]"
